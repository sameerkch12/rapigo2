...
export function RideProvider({ children }: { children: ReactNode }) {
  ...
  const setPickup = (loc: Location) => setRide((r) => ({ ...r, pickup: loc }));
  const setDestination = (loc: Location) => setRide((r) => ({ ...r, destination: loc }));

  const selectVehicle = (id: string, fare: number) => {
